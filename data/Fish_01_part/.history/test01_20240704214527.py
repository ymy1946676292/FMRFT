...
for seq in seqs:
    ...
    label_path=os.path.join(label_root,seq)

    images = os.listdir(
        '/mnt/sdb/DataSet/objectTracking/Fish_01/images/train/'+seq)
    ...
    for i,image in enumerate(images):  
        i+=1
        number_name = format(number_name, '06d')
        ...
        os.rename(os.path.join(label_path,image.split('.')[0]),new_label_name)