...
def get_args_parser():
    ...
    parser.add_argument('--hidden_dim', default=256, type=int,
                        help="Size of the embeddings (dimensione feedforward layers in the transformer blocks")
    # parser.add_argument('--hidden_dim', default=256, type=int,
    ...
    # dataset parameters  todo 第一行重要
    parser.add_argument('--dataset_file', default='e2e_joint')
    parser.add_argument('--gt_file_train', type=str)
    parser.add_argument('--gt_file_val', type=str)
    parser.add_argument('--coco_path', default='/mnt/sdb/DataSet/COCO', type=str)
    ...
    parser.add_argument('--mot_path', default='/mnt/sdb/DataSet/objectTracking/', type=str)
    parser.add_argument('--input_video', default='figs/demo.avi', type=str)
    parser.add_argument('--data_txt_path_train',
                        default='./datasets/new_data_path/detmot17.train', type=str,
                        help="path to dataset txt split")
    parser.add_argument('--data_txt_path_val',
                        default='./datasets/new_data_path/detmot17.train', type=str,
                        help="path to dataset txt split")
    parser.add_argument('--img_path', default='./datasets/data/valid/JPEGImages/')
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            ...
            if (epoch + 1) % args.lr_drop == 0 or (epoch + 1) % args.save_period == 0 or (
                    ((args.epochs >= 100 and (epoch + 1) > 100) or args.epochs < 100) and (epoch + 1) % 5 == 0):
